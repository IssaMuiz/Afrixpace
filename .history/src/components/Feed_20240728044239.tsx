...
const Feed = () => {
  ...
  return (
    <div className="mt-32 max-w-[900px]  tablet:mr-[320px]  desktop:ml-[300px]  tablet:ml-[30px] mb-10 flex flex-1 flex-col mx-5">
      {Feeds.map((feed) => (
        <div key={feed.id}>
          <hr />
          ...
          <div className="bg-[#313131] p-1 rounded-lg mt-2">
            <IconList />
          </div>
        </div>
      ))}
