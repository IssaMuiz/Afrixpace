              ...
              <div className="flex items-center gap-2 ">
                <div className="relative group">
                  ...
                  "
                    ...
                    alt=""
                  />
                  <div className="bg-gray-700 rounded-lg w-auto absolute  transform left-1/2 translate-x[-50%] translate-y-4 duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center z-10">
