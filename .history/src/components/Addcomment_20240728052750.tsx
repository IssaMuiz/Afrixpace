...
const Addcomment = (props: commentType) => {
  ...
  return (
    <div className="mb-2 mx-2">
      {props.showComment && (
        <div>
          <div className="flex items-center gap-5 justify-between bg-gray-200 p-1 rounded-md">
            <div className="">
              <img
            ...
            <div className="max-w-[500px]   text-black flex-1">
              <textarea
                ...
                placeholder="comment"
                className="w-full border p-1 flex-1 rounded-lg focus:outline-none focus:ring-2 text-center resize-none"
              />
            </div>
