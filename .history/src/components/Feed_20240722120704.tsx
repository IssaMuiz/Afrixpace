      ...
      {post.map((feed) => (
        <div key={feed.id}>
          ...
          <div className=" w-full hover:bg-gray-100 hover:rounded-lg cursor-pointer p-2 mt-2">
            ...
            <div
              onClick={() => handlePost(feed.id)}
              className="flex gap-10 mt-2 align-center"
            >
              <div
                className={`flex bg-gray-200 ${
                  vote === "upvote" && feed.expanded ? "bg-orange-600" : ""
                } ${
                  vote === "downvote" && feed.expanded ? "bg-blue-600" : ""
                }  p-1 gap-3 items-center rounded-2xl justify-center `}
              >
                <button onClick={() => toggleUpvote(feed.id)}>
                  {vote === "upvote" ? (
                    <div>
                      <svg
                ...
                <button onClick={() => toggleDownvote(feed.id)}>
                  {vote === "downvote" && feed.expanded ? (
                    <div>
                      <svg
                        className="fill-white"
                        height="24"
