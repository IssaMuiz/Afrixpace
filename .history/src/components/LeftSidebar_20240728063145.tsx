...
const LeftSidebar = (props: Sidenavtype) => {
  ...
  return (
    <div
      className={`w-72 desktop:flex p-10 pl-12 backdrop-blur-3xl flex-col border-r bg-opacity-50 mt-16  fixed z-0 h-full left-0 overflow-scroll top-0 scrollbar ${
