  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center">
      ...
      <div className="right-navbar tablet:flex gap-2 overflow-hidden whitespace-nowrap mx-10  mobile:hidden">
        <div className="h-10 w-10 rounded-full bg-[#1c1e21] cursor-pointer hover:bg-gray-600">
          <img className="p-1" src="create-removebg-preview (1).png" alt="" />
        </div>
        <div className="h-8 w-8 rounded-full bg-[#1c1e21] hover:bg-white cursor-pointer">
          <img
            className="p-1"
