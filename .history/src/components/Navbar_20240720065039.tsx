    ...
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center ">
      ...
      >
        <img
          ...
          alt="hambuger-icon"
        />
        <div className="bg-gray-700 rounded-lg w-18 absolute  top-12 transform translate-x-0.5  duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center">
