...
const Navbar = () => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center">
      ...
      <div className="right-navbar tablet:flex gap-2 overflow-hidden whitespace-nowrap ml-10 mobile:hidden">
        <img className="h-10 w-9 rounded-full" src="assets/create.png" alt="" />

        <img
          className="h-10 w-10"
          src="assets/noti-removebg-preview.png"
          alt=""
        />
        <div>
          <div className="flex items-center">
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <button onClick={signOutUser} className=" border bg-gray-200">
                  Log out
                </button>
              </div>
            ) : (
