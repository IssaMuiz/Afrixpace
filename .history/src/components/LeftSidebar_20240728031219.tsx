              ...
              <div className="flex gap-2 ">
                ...
                >
                  <circle
                    ...
                    stroke-width="4"
                  />
                  <path d="M32 2C25.3726 2 19.2822 4.26685 14.5246 7.92398L32 32L49.4754 7.92398C44.7178 4.26685 38.6274 2 32 2Z" />
                  <path d="M17.1546 9.39688C11.8685 13.5815 8.48615 19.9292 7.3771 27.0919L32 32L56.6229 27.0919C55.5139 19.9292 52.1315 13.5815 46.8454 9.39688L32 32L17.1546 9.39688Z" />
                  <path d="M2 32C2 38.6274 4.26685 44.7178 7.92398 49.4754L32 32L7.92398 14.5246C4.26685 19.2822 2 25.3726 2 32Z" />
                  <path d="M9.39688 46.8454C13.5815 52.1315 19.9292 55.5139 27.0919 56.6229L32 32L27.0919 7.3771C19.9292 8.48615 13.5815 11.8685 9.39688 17.1546L32 32L9.39688 46.8454Z" />
                  <path d="M56.6229 32C55.5139 38.6274 52.1315 44.7178 46.8454 49.4754L32 32L46.8454 14.5246C52.1315 19.2822 55.5139 25.3726 56.6229 32Z" />
                  <path d="M46.8454 46.8454C44.7178 44.7178 38.6274 42.451 32 42.451V32H22.5488C22.5488 38.6274 19.2822 44.7178 17.1546 46.8454L32 32L46.8454 46.8454Z" />
                  <path d="M17.1546 46.8454C19.2822 44.7178 25.3726 42.451 32 42.451V32H41.4512C41.4512 38.6274 44.7178 44.7178 46.8454 46.8454L32 32L17.1546 46.8454Z" />
                </svg>
