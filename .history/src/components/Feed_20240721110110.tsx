        ...
        <div>
          ...
          <div className=" w-full hover:bg-gray-100 hover:rounded-lg cursor-pointer p-2 mt-2">
            ...
            <div className="flex gap-10 mt-2 align-center">
              <div
                className={`flex bg-blue-500  p-1 gap-3 items-center rounded-2xl justify-center hover:bg-gray-300 `}
              >
                <svg
                  className="upvote h-6 w-6 bg-white fill-white rounded-full"
                  viewBox="0 0 24 24"
