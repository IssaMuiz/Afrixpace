...
const Navbar = () => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-evenly fixed top-0 left-0 right-0 h-16 items-center">
      <div className="mr-2">
        <img
      ...
      <div className="middle-navbar flex flex-2 mx-2">
        <input
      ...
      <div className="right-navbar pl-0 flex gap-2 whitespace-nowrap flex-1">
