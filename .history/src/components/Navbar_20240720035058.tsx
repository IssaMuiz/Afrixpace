...
const Navbar = (props: sideNavtype) => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center hover:bg-[#1c1e21]">
      <div className="ml-2">
        <img
          onClick={props?.toggleDisplaynav}
          className="desktop:hidden h-5 w-5 cursor-pointer"
      ...
      <div>
        <div className="text-white text-3xl ml-2  ">AfriXpace</div>
      </div>
