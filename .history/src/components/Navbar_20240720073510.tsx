      ...
      <div className="right-navbar flex gap-2 whitespace-nowrap mr-5">
        ...
        <div className="h-8 w-8 rounded-full group relative bg-[#1c1e21] hover:bg-[#182947] cursor-pointer">
          <img
            ...
            alt=""
          />
          <div className="bg-gray-700 rounded-lg w-auto absolute  transform translate-x-1 translate-y-4 duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center z-10">
