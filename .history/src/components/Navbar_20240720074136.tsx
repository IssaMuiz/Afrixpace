      ...
      <div className="right-navbar flex gap-2 whitespace-nowrap mr-5">
        <div className="h-8 w-8 flex items-center justify-center rounded-full bg-[#1c1e21]  cursor-pointer hover:bg-[#182947]relative group ">
          <img
            ...
            alt=""
          />
          <div className="bg-gray-700 rounded-lg w-auto absolute  transform translate-x-2 translate-y-9 duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center">
