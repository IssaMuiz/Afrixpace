...
const LeftSidebar = (props: Sidenavtype) => {
  ...
  return (
    <div
      className={`w-72 desktop:flex p-10 pl-12 backdrop-blur-lg flex-col border-r mt-16  fixed z-0 h-full left-0 overflow-scroll top-0 ${
                ...
                <div className="">
                  {category.dropdownLink.map((dropDownlink) => (
                    <Link
                      ...
                      className="ml-10 flex border-l text-white flex-col gap-y-2  p-2 transition-transform duration-300 mb-5 hover:bg-[#313131] rounded-lg cursor-pointer"
                    >
                      {dropDownlink.name}
                    </Link>
                  ))}
