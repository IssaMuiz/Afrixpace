...
const IconList = () => {
  ...
  return (
    <div className="flex gap-10 mt-2 align-center">
      <div
        className={`flex ${upvote ? "bg-orange-600" : "bg-gray-200"} ${
          downvote ? "bg-purple-600" : "bg-gray-200"
      ...
      >
        <div onClick={toggleUpvote}>
          {upvote ? (
            ...
            <svg
              className={upvote ? "hover:fill-orange-500" : ""}
              height="24"
              viewBox="0 0 24 24"
              width="24"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div onClick={toggleDownvote}>
          {downvote ? (
            ...
            <svg
              className={downvote ? "hover:fill-blue-600" : ""}
              height="24"
              viewBox="0 0 24 24"
              width="24"
              xmlns="http://www.w3.org/2000/svg"
