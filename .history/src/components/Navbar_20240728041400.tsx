...
const Navbar = (props: sideNavtype) => {
  ...
  return (
    <div
      className={`left-navbar bg-[#080808] backdrop-blur-sm bg-opacity-30 flex justify-between fixed top-0 left-0 right-0 h-16 border-b border-gray-200 items-center z-10 ${
