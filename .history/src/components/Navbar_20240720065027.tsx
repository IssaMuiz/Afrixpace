  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center ">
      <div
        ...
        className="ml-2 h-9 w-9 rounded-full hover:bg-[rgb(28,30,33)] active:bg-[#182947] content-center cursor-pointer relative group"
      >
        <img
          ...
          alt="hambuger-icon"
        />
        <div className="bg-gray-700 rounded-lg w-18 absolute  top-12 transform translate-x-1  duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center">
