...
const Navbar = () => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center">
      <div className="ml-2">
        <img
          className="desktop:hidden h-5 w-5"
          src="assets/hamburger-menu (1).png"
          alt="hambuger-icon"
        />
      </div>
      <div>
        <div className="text-white text-3xl ml-4  ">AfriXpace</div>
      </div>
      <div className="middle-navbar flex flex-1 mx-2">
        ...
        <div className="rounded-r-md mr-7 h-10 w-10 bg-green-500">
          <img
      ...
      <div className="right-navbar pl-0 flex gap-2 whitespace-nowrap mr-5">
