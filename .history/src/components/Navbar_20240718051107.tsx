...
const Navbar = () => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center">
      <div>
        <div className="text-white text-3xl ml-8 mr-10 mobile:hidden tablet:block">
          AfriXpace
        </div>
      ...
      <div className="right-navbar tablet:block desktop:block gap-2 overflow-hidden whitespace-nowrap mx-10  mobile:hidden">
