        ...
        <div>
          ...
          <div className=" w-full hover:bg-gray-100 hover:rounded-lg cursor-pointer p-2 mt-2">
            ...
            <div className="flex gap-10 mt-2 align-center">
              <div
                className={`flex bg-red-500 p-1 gap-1 w-24 items-center rounded-2xl justify-center hover:bg-gray-300 `}
              >
                <svg
                ...
                <img
                  className="w-5 h-5"
                  src="public/assets/downvote-white-removebg-preview.png"
                  alt=""
                />
              </div>
