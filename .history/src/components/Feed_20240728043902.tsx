...
const Feed = () => {
  ...
  return (
    <div className="mt-32 max-w-[900px] rounded-lg tablet:mr-[320px]  desktop:ml-[300px]  tablet:ml-[30px]  flex flex-1 flex-col mx-5">
      {Feeds.map((feed) => (
        <div key={feed.id}>
          <hr />
          <div className=" w-full cursor-pointer bg-[#313131]  text-white p-2 mt-2">
