...
const Navbar = (props: sideNavtype) => {
  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center z-10">
      ...
      <div className="middle-navbar mx-2 max-w-[700px] flex flex-1 ">
        <input
          className="h-10 w-full px-2 outline-none text-xl border rounded-l-md"
          placeholder="Search"
          type="text"
        />
      ...
      <div className="right-navbar flex gap-2 whitespace-nowrap mr-9">
        <div className="h-8 w-8 flex items-center justify-center rounded-full bg-[#1c1e21]  cursor-pointer hover:bg-[#182947] relative group">
          ...
          <div
            onClick={createPost}
            className="bg-gray-700 rounded-lg w-auto absolute transform translate-x-2 translate-y-11 duration-300 opacity-0 transition-opacity group-hover:visible invisible group-hover:opacity-100 text-center"
          >
