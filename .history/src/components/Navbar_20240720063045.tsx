  ...
  return (
    <div className="left-navbar bg-black flex justify-between fixed top-0 left-0 right-0 h-16 items-center ">
      ...
      <div className="relative group">
        ...
        <div className="bg-gray-300 rounded-lg w-14 absolute left-1/2 top-10 transform translate-x-1/2 duration-300 opacity-0 transition-opacity group-hover:opacity-100">
